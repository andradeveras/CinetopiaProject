...
let movies: [Movie] = [
    ...
    Movie(id: 4, title: "Thor: Amor e Trovão", image: "ThorImage", synopsis: "Thor busca por paz, mas seus planos são interrompidos por Gorr, o Carniceiro dos Deuses, um assassino galáctico. Para combater esta ameaça, ele pede que Rei Valquíria, Korg e Jane Foster o ajudem.", rate: 7.2, releaseDate: "07/07/2022"),
    
    Movie(id: 5, title: "A Órfã", image: "OrfaImage", synopsis: "Uma série de eventos alarmantes faz com que uma mulher acredite que algum mal esteja por trás do rosto angelical da filha de nove anos, recentemente adotada.", rate: 8.5, releaseDate: "24/07/2009")
]
